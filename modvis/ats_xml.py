...
def get_main(config, subsurface_props, nlcd_labels, labeled_sets={}, side_sets={}, subcatchment_labels=None):
    ...
    ats_input_spec.public.add_observations_water_balance(main_list, region="computational domain", surface_region= "surface domain", boundary_region="external_sides")
    
    if subcatchment_labels is not None:
        for region in subcatchment_labels:
            ats_input_spec.public.add_observations_water_balance(main_list, region, 
